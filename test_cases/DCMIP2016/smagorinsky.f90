...
!!!!!
    ...
    ! Distribution of surface momentum flux over multiple levels
...
!!!!!
    ...
    if (nl%split_scalars > 0) then
       ...
       do n = 1, num_scalar
          ...
          do k = ka, mza-1
             ...
             if (nl%test_case == 131 .and. scalar_tab(n)%name == 'THIL') then
    ...
    if (nl%test_case == 131) go to 10 ! No surface flux or emission for supercell test case
