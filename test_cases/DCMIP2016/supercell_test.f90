...
! OLAM arrays for storing initial velocity and thil for supercell test case.
! Horizontal and vertical turbulent mixing will be applied only to
! perturbations from initial values of these fields.

  real, allocatable :: vxe_init(:,:)
