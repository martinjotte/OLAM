...
use mem_basic,   only: vmc, vc, vxe, vye, vze, thil, rho, wmc, wc, sh_w
...
do jstp = 1,nstp  ! nstp = no. of finest-grid-level aco steps in dtlm(1)
   ...
   if (nl%test_case == 11 .or. &
      ...
      call olam_dcmip_prescribedflow(time0,vmsc,wmsc,rho_old)
