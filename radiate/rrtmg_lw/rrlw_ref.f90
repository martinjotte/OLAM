...
! each subsequent ln(pressure) differs from the previous one by 0.2.
  ...
  real(kind=rb), parameter :: pref(59) = (/ &
  ...
  real(kind=rb), parameter :: preflog(59) = (/ &
  ...
  real(kind=rb), parameter :: tref(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls1(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls2(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls3(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls4(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls5(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls6(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls7(59) = (/ &
  ...
  real(kind=rb), parameter :: chi_mls1i(59) = 1.0 / chi_mls1
  real(kind=rb), parameter :: chi_mls2i(59) = 1.0 / chi_mls2
  real(kind=rb), parameter :: chi_mls3i(59) = 1.0 / chi_mls3
  real(kind=rb), parameter :: chi_mls4i(59) = 1.0 / chi_mls4
  real(kind=rb), parameter :: chi_mls5i(59) = 1.0 / chi_mls5
  real(kind=rb), parameter :: chi_mls6i(59) = 1.0 / chi_mls6
  real(kind=rb), parameter :: chi_mls7i(59) = 1.0 / chi_mls7

  real(kind=rb), parameter :: chi_mls1_2(59) = chi_mls1 * chi_mls2i
  real(kind=rb), parameter :: chi_mls1_3(59) = chi_mls1 * chi_mls3i
  real(kind=rb), parameter :: chi_mls1_4(59) = chi_mls1 * chi_mls4i
  real(kind=rb), parameter :: chi_mls1_6(59) = chi_mls1 * chi_mls6i
  real(kind=rb), parameter :: chi_mls3_2(59) = chi_mls3 * chi_mls2i
  real(kind=rb), parameter :: chi_mls4_2(59) = chi_mls4 * chi_mls2i
