...
use mem_grid,    only: mza, mva, mwa, lpv, lpw, &
                       ...
                       unx, uny, vnx, vny, wnx, wny, wnz, glatw, glonw, topw
use massflux,    only: tridiffo
...
! SPECIAL - WM2&5
   ...
   press(k,iw) = press_t(k) + fp * delex_rho(k)
...
!------------------------------------------------------------
! SPECIAL - WM2&5
             * 9.8 * .5 * (rho(k,iw1) + rho(k,iw2)) &
! rho is h_s (height of sfc)
! END SPECIAL - WM2&5
!------------------------------------------------------------
