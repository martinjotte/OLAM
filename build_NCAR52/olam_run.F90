...
use consts_coms, only: r8, erad, erad2, erad4, eradsq, erador5, eradi, &
                       omega, omega2, xscale
...
!----------------------------------------------------------------------
! NCAR DCMIP cases - override some OLAMIN parameters, 
! define values for ERAD and OMEGA based on test case number

erad = 6371.22e3
omega = 7.292e-5
xscale = 1.0

if     (nl%test_case == 200) then
   omega = 0.
elseif (nl%test_case == 201) then
   xscale = 500.
   erad = erad / xscale
   omega = 0.
elseif (nl%test_case == 21 ) then
   xscale = 500.
   erad = erad / xscale
   omega = 0.
elseif (nl%test_case == 22 ) then
   xscale = 500.
   erad = erad / xscale
   omega = 0.
elseif (nl%test_case == 31 ) then
   ...
   erad = erad / xscale
   omega = 0.
elseif (nl%test_case == 411) then
   xscale = 10.
   erad = erad / xscale
   omega = omega * xscale
elseif (nl%test_case == 412) then
   xscale = 100.
   erad = erad / xscale
   omega = omega * xscale
elseif (nl%test_case == 413) then
   xscale = 1000.
   erad = erad / xscale
   omega = omega * xscale
endif
