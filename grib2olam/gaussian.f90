...
!-----------------------------------------------------------------------
    ...
    real :: fk           ! real k
    real :: xz           ! abscissa estimate
    real :: pkm1         ! |
    real :: pkm2         ! |-polynomials
    real :: pkmrk        ! |
    real :: pk           ! |
    real :: sp           ! current iteration latitude increment
    real :: avsp         ! |sp|
    real :: fn           ! real n
