...
subroutine arrsnd_theta()
  ...
  if (ipsflg == 0) then
     ...
     ! PS array is pressure in mb with HS(1) = height of lowest sounding
     ! level. Compute temperature and humidity
...
subroutine arrsnd_tair()
  ...
  if (ipsflg == 0) then
     ...
     ! PS array is pressure in mb with HS(1) = height of lowest sounding
     ! level. Compute potential temperature and humidity
  ...
  elseif (ipsflg == 1) then
     ...
     ! We know pressure at the surface; compute potential temperature and
     ! humidity.
...
! +---------------------------------------------------------------------
  ...
  call hintrp_ee(nsndg,thds,hs,mza,th01d,zt)
  call hintrp_ee(nsndg,  us,hs,mza, u01d,zt)
  call hintrp_ee(nsndg,  vs,hs,mza, v01d,zt)

  if (miclevel >= 1) then
     call hintrp_ee(nsndg,rts,hs,mza,rt01d,zt)
  else
     rt01d(1:mza) = 0.
  endif
  ...
  call hintrp_ee(nsndg,ps,hs,mza,pr01d,zt)
