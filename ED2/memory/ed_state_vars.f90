...
!============================================================================!
  ...
  ! ===================================================
    ...
    type(edtype),target :: cgrid
       ...
       if(associated(cgrid%iwl                    )) deallocate(cgrid%iwl                    )
...
!==========================================================================================!
   ...
   subroutine filltab_edtype_p10(cgrid,igr,init,var_len,var_len_global,max_ptrs,nvar)
      ...
      if (associated(cgrid%iwl)) then
         nvar=nvar+1
         call vtable_edio_i(npts,cgrid%iwl,nvar,igr,init,cgrid%pyglob_id                  &
                           ,var_len,var_len_global,max_ptrs                                &
                           ,'IWL :10:hist:anal:dail:mont:dcyc:year') 
         call metadata_edio(nvar,igr,'OLAM IWL index of polygon','NA','ipoly')
      end if
