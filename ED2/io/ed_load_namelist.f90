!==========================================================================================!
!==========================================================================================!
subroutine ed_read_nl(namelist_name)
   ...
   if (.not. fexists) then
      call fatal_error('The namelist file '//trim(namelist_name)//' is missing.'           &
                      ,'ed_read_nl','ed_load_namelist.f90')
   end if
   ...
   call override_ed2_with_olam()


   return
end subroutine ed_read_nl
!==========================================================================================!
!==========================================================================================!

subroutine override_ed2_with_olam()
...
!  endif
  ...
  nl%idatez = mytime%date
  nl%itimez = int(mytime%time/3600.0)*100+nint(mod(mytime%time,3600.))
  ...
  nl%soil_database = soil_database
  nl%soilstate_db = soilstate_db
  nl%soildepth_db = soildepth_db
  nl%isoilstateinit = isoilstateinit
  nl%isoildepthflg = isoildepthflg
  ...
  return
end subroutine override_ed2_with_olam



!==========================================================================================!
!==========================================================================================!
subroutine ed_copy_nl(copy_type)
   ...
   use ed_consts_coms          , only : vonk                      & ! intent(in)
                                   , day_sec                   & ! intent(in)
                                   , hr_sec                    & ! intent(in)
                                   , min_sec                   ! ! intent(in)
