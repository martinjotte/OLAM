...
real function cdf2normal(mycdf)
   use sp_therm_lib, only : toler, maxfpo
   implicit none
   !----- Arguments -----------------------------------------------------------------------!
...
real function cdf(normal)
   use ed_consts_coms, only : srtwoi
   implicit none
   !----- Arguments -----------------------------------------------------------------------!
...
real function cbrt(x)
   use ed_consts_coms, only: onethird
   implicit none
   !----- Arguments. ----------------------------------------------------------------------!
   real, intent(in) :: x
   !---------------------------------------------------------------------------------------!
...
real(kind=8) function cbrt8(x)
   use ed_consts_coms, only: onethird8
   implicit none
   !----- Arguments. ----------------------------------------------------------------------!
...
real function errorfun(x)
   use ed_consts_coms, only: onethird,onesixth,sqrtpii
   use sp_therm_lib , only: toler,maxlev 
   implicit none
   !----- Arguments -----------------------------------------------------------------------!
   real, intent(in) :: x
   !----- Local variables -----------------------------------------------------------------!  
...
real function expected(xmin,xmean,sigmax)
   use ed_consts_coms, only : srtwo      & ! intent(in)
                         , srtwoi     & ! intent(in)
                         , sqrttwopi  & ! intent(in)
