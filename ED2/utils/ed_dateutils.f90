...
subroutine ed_date_abs_secs2 (year1,month1,date1,hour1,seconds)
   use ed_consts_coms, only : day_sec,hr_sec,min_sec
   implicit none
   real(kind=8) :: seconds
   ...
   return
end subroutine ed_date_abs_secs2
!==========================================================================================!
!==========================================================================================!
...
subroutine date_2_seconds (iyearc,imonthc,idatec,itimec, &
   ...
   call ed_date_abs_secs2(iyearc,imonthc,idatec,itimec,secs_c)
   call ed_date_abs_secs2(iyeara,imontha,idatea,itimea,secs_a)
...
!==========================================================================================!
!==========================================================================================!
subroutine ed_date_secs_ymdt (seconds,iyear1,imonth1,idate1,ihour1)
   use ed_consts_coms, only : day_sec,hr_sec,min_sec
   implicit none
   ...
   return
end subroutine ed_date_secs_ymdt
!==========================================================================================!
!==========================================================================================!
...
subroutine date_add_to (inyear,inmonth,indate,inhour  &
   ...
   call ed_date_abs_secs2(inyear,inmonth,indate,inhour,secs)

   secs=secs+ttinc

   call ed_date_secs_ymdt(secs,outyear,outmonth,outdate,outhour)
