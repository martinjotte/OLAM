...
!       integer, parameter :: zero = 0_dp
        ...
        real(kind=real_16), parameter, private :: min_val = 1.0d-36
...
! --------------------------------------------------------------------------
        ...
        c_mul_cc%real_part = z1%real_part * z2%real_part - z1%imag_part * z2%imag_part
        c_mul_cc%imag_part = z1%real_part * z2%imag_part + z1%imag_part * z2%real_part
...
! --------------------------------------------------------------------------
        ...
        c_div_cc%real_part = sign(max(abs(c_div_cc%real_part),       &
                                      min_val), c_div_cc%real_part)

        c_div_cc%imag_part = (  z1%imag_part * z2%real_part          &
                              - z1%real_part * z2%imag_part) * denom
        c_div_cc%imag_part = sign(max(abs(c_div_cc%imag_part),       &
                                      min_val), c_div_cc%imag_part)
