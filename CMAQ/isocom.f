...
C
     ...
     &                     WT, GAS, AERLIQ, AERSLD, SCASI, OTHER, do_isrp3f)
...
C
      ...
      PSI  = MAX(TINY4, MIN(PSI,MOLAL(3)))       ! Constrict in acceptible range
C
...
C
      CALAIN = ABS(GAMIN8-GAMA(8)) > EPSACT * GAMIN8
      IF (FRST) THEN
         CALAOU = CALAIN
         FRST   = .FALSE.
      ENDIF
