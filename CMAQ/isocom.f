...
C
     ...
     &                     WT, GAS, AERLIQ, AERSLD, SCASI, OTHER)
      ...
      CHARACTER SCASI*15
      real(8) :: WI(NCOMP), WT(NCOMP),  GAS(NGASAQ),  AERSLD(NSLDS),
...
C=======================================================================
C
C     SUBROUTINE GETPARM (WFTYPI,  IACALCI, EPSI, MAXITI, NSWEEPI, 
C    &                    EPSACTI, NDIVI, NADJI)
C     use isrpia
C     IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     INTEGER  WFTYPI
...
C
      ...
      integer            :: a1, ia1, inds, indr, indsl, indsh
      integer            :: iposl, iposh
      real               :: rat, wf
...
C
      WF     = (SO4I-ASSO4(INDSL))/(ASSO4(INDSH)-ASSO4(INDSL) + 1.e-7)
...
C
      AGAMA = agfc / real(TEMP)**1.5    ! Debye Huckel const. at T
      SION  = SQRT(IONIC)
      H     = AGAMA*SION/(1.+SION)
C
      DO 100 I=1,4
...
C
C      IF (IACALC.EQ.0) THEN              ! K.M.; FULL
C         CALL KMFUL3 (IONIC, SNGL(TEMP),G0(2,1),G0(2,2),G0(2,4),
C     &               G0(3,2),G0(3,4),G0(3,1),G0(1,2),G0(1,3),G0(3,3),
C     &               G0(1,4),G0(1,1),G0(2,3))
C      ELSE                               ! K.M.; TABULATED
         CALL KMTAB (IONIC, SNGL(TEMP),G0(2,1),G0(2,2),G0(2,4),
     &               G0(3,2),G0(3,4),G0(3,1),G0(1,2),G0(1,3),G0(3,3),
     &               G0(1,4),G0(1,1),G0(2,3),G0(4,4),G0(4,1),G0(5,2),
...
C
C      IF (IACALC.EQ.0) THEN              ! K.M.; FULL
C         CALL KMFUL2 (IONIC, SNGL(TEMP),G0(3,2),G0(3,4),G0(1,2),
...
C
C      IF (IACALC.EQ.0) THEN              ! K.M.; FULL
C         CALL KMFUL1 (IONIC, SNGL(TEMP),G0(3,2),G0(1,2),
C     &                G0(1,3),G0(3,3))
C      ELSE                               ! K.M.; TABULATED
         CALL KMTAB (IONIC, SNGL(TEMP),G0(2,1),G0(2,2),G0(2,4),
     &               G0(3,2),G0(3,4),G0(3,1),G0(1,2),G0(1,3),G0(3,3),
...
C
     ...
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
      ...
      real, intent(out) :: G01,G02,G03,G04,G05,G06,G07,G08,G09,G10
      real, intent(out) :: G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23
      integer           :: IND
C
C *** Find temperature range
C
      IND = NINT(0.04*(TEMP-198.0))
C
C *** Call appropriate routine
C
      IF (IND.LE.0) THEN

         CALL KM198 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)

      ELSEIF (IND.EQ.1) THEN

         CALL KM223 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)

      ELSEIF (IND.EQ.2) THEN

         CALL KM248 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)

      ELSEIF (IND.EQ.3) THEN

         CALL KM273 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)

      ELSEIF (IND.EQ.4) THEN

         CALL KM298 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)

      ELSE

         CALL KM323 (IN,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                  G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM198 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM223 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM248 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM273 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM298 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
...
C=======================================================================
C
      SUBROUTINE KM323 (IONIC,G01,G02,G03,G04,G05,G06,G07,G08,G09,G10,
     &                        G11,G12,G15,G16,G17,G18,G19,G20,G21,G22,G23)
