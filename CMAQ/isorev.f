...
C
      ...
      real    :: hi0, ohi0, hi, ohi, del, gg, molalr(4:5)
      real(8) :: aml5
      integer :: i
C
C
...
C
      ...
      A2  = XK2*R*TEMP*GAMA(8)**2 / (XKW*RH*GAMA(9)**2)
      A3I = GAMA(10) / (XK4*R*TEMP*WATER**2)
...
C
      ...
      real    :: hi, sdd, hso4i, ggno3, ggcl, del, akw, akw0, a2
      real    :: hi0, ohi0, gg0, a3i, a4i, molalr(2:6)
      integer :: i
C
C *** SETUP PARAMETERS ************************************************
C
...
C
      ...
      A3I     = GAMA(10)**2 / (XK4 *R*TEMP*WATER**2)    ! HNO3 <==> NO3-
      A4I     = GAMA(11)**2 / (XK3 *R*TEMP*WATER**2 )   ! HCL  <==> CL-
C
      GNH3    = NH4I/(HI*A2)
      GHNO3   = HI*NO3I*A3I
      GHCL    = HI*CLI *A4I
...
C
      ...
      real    :: gg, sdd, hi, ohi, so4i, cli, hso4i, akw, del
...
C
      A2       = XK2*R*TEMP*GAMA(10)**2/(XKW*GAMA(5)**2) ! NH3  <==> NH4+
      A3I      = GAMA(10) / (XK4*R*TEMP*WATER**2)        ! HNO3 <==> NO3-
      A4I      = GAMA(11) / (XK3*R*TEMP*WATER**2)        ! HCL  <==> CL-
