...
C
      IF (NH4I*NH4I*SO4I .GT. A7) THEN
         ...
         DD =-((WAER(2)-ROOT3)*WAER(3)**2 + A7)/4.D0
...
C
      IF (NH4I*NH4I*SO4I .GT. A7) THEN
         ...
         DD =-((WAER(2)-ROOT3)*(WAER(3)-ROOT2)**2 + A7)/4.D0
         CALL POLY3(BB, CC, DD, ROOT1, ISLV)
         IF (ISLV.NE.0) ROOT1 = TINY
...
C
      IF (NAI*NAI*SO4I .GT. A5) THEN
         ...
         DD =-0.25D0*(CHI1*(WAER(1)-ROOT3)**2 - A5) 
         CALL POLY3(BB, CC, DD, ROOT1, ISLV)
         IF (ISLV.NE.0) ROOT1 = TINY
...
C
     ...
     &      (WAER(3)-ROOT4)**2 + ROOT4*(ROOT1+ROOT7-(WAER(2)-WAER(6)))
         DD =-0.25*((WAER(3)-ROOT4)**2 *
...
C
     ...
     &         0.25D0*(WAER(7)-ROOT13)**2
         DD =-0.25*((WAER(7)-ROOT13)**2*(WAER(2)-WAER(6)) - A9)
         CALL POLY3(BB, CC, DD, ROOT9, ISLV)
         IF (ISLV.NE.0) ROOT9 = TINY
...
C
     ...
     &         0.25D0*(WAER(7)-ROOT13-ROOT14)**2
         DD =-0.25*((WAER(7)-ROOT13-ROOT14)**2*(WAER(2)-WAER(6)) - A9)
         CALL POLY3(BB, CC, DD, ROOT9, ISLV)
         IF (ISLV.NE.0) ROOT9 = TINY
